        ...
        <div className="sectionthree__body">
          ...
          <div className="sectionthree__cards">
            <div className="sectionthree__card one">
              ...
              <p>
                Пройдите быструю и простую <br /> регистрацию на нашей <br />{" "}
                платформе.
              </p>
            </div>
            <div className="sectionthree__card two">
              ...
              <p>
                Настройте платежные <br /> параметры в соответствии с <br />{" "}
                потребностями.
              </p>
            </div>
            <div className="sectionthree__card three">
              ...
              <p>
                Запустите ваш сайт и начните <br /> принимать платежи от <br />{" "}
                клиентов.
              </p>
            </div>
          </div>

        ...
        <div className="sectionone__body">
          ...
          <div className="sectione__desc">
            ...
            <p className="sectionone__text">
              ...
              приложений, которые <br /> принимают платежи и отправляют выплаты
              по всему миру. Продукты Stripe позволяют <br /> осуществлять
              платежи онлайн и лично <br />
              розничным продавцам, компаниям, <br /> занимающимся подпиской,
              программным <br />
              платформам и маркетплейсам, а также всему, <br /> что находится
              между ними.
            </p>
          </div>
        </div>
